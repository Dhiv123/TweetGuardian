...
def login():
    ...
    if request.method == 'POST' and 'email' in request.form and 'password' in request.form:
        ...
        if users:
            ...
            curr.execute("select count(`Not hate`) from ml_table where `Not hate` = 1 and username = %s",(username,))
            count2 = curr.fetchone()
            count2 = count2['count(`Not hate`)']
            ...
            plt.title("Hate vs Not Hate Pie Chart")
            ...
            return render_template('dash.html', msg=msg, data=data, count=count,count1=count1,count2=count2,pie_chart_image=pie_chart_image_path,chart_path=chart_path )
...
def predict():
    if request.method == 'POST':
        ...
        if user_data:
                ...
                curr.execute('INSERT INTO ml_table (username, Post, Hate, `Not hate`,Prediction) VALUES (%s, %s, %s, %s,%s)',
